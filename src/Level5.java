 ...
 */
public class Level5 extends GameController {
	...
	/**
	 * Creates the game area for Level 5.
	 */
	...
	public void startGame() {
		...
		ReflectorPath redDuckFlyAnimation = new ReflectorPath(redDuck,new int[]{(duckImageWidth), FRAME_WIDTH_VALUE/4},1,FRAME_WIDTH_VALUE/60,FRAME_HEIGHT_VALUE/90);
		redDuckFlyAnimation.startTimeline();

		StraightPath blackDuckFlyAnimation = new StraightPath(blackDuck,new int[]{duckImageWidth/2,FRAME_HEIGHT_VALUE/13},1,FRAME_WIDTH_VALUE/15,FRAME_HEIGHT_VALUE/90);
		blackDuckFlyAnimation.startTimeline();

		StraightPath blueDuckFlyAnimation = new StraightPath(blueDuck,new int[]{FRAME_WIDTH_VALUE-(duckImageWidth),FRAME_HEIGHT_VALUE/5},-1,FRAME_WIDTH_VALUE/15,FRAME_HEIGHT_VALUE/90);
